...
# Exercise 19: write a function that, for a given sex and family, calculates the mean rate of growth as the ratio between the (average) initial size, and the (average) change in size between the first and last day.

```{r}
growthRate=function(day1_data, day13_data){
  #??????
  #??????
}
```
