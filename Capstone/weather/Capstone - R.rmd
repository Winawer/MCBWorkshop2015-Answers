...
Once you've done that, return to the Python section.  Write a new function, ```yearly_maximum``` that calculates the yearly maximum temperature and re-run the analsis.
